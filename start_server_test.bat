@echo off
:start
set serverName=The LionZ Server TEST
set serverLocation="D:\SteamLibrary\steamapps\common\DayZServer"
set serverPort=2302
set serverConfig=serverDZ.cfg
set serverProfile=profiles
set serverCPU=4
set MOD_LIST=@CF;@Dabs-Framework;@VPPAdminTools;@DayZ-Expansion-Bundle;@DayZ-Expansion-Licensed

title %serverName%
cd %serverLocation%
echo (%time%) %serverName% iniciado SEM BaseBuildingPlus.
